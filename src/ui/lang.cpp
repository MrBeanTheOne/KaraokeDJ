...
static const std::unordered_map<std::wstring, std::wstring>& frMap() {
    static const std::unordered_map<std::wstring, std::wstring> m = {
        ...
        {L"downloads and installs — this is v",
         L"télécharge et installe — version v"},
        {L"DOWNLOADING…", L"TÉLÉCHARGEMENT…"},
        {L"the app restarts into the installer when ready",
         L"l'application redémarre dans l'installateur une fois prêt"},
        {L"update download failed — use CHECK FOR UPDATES again or the GitHub page",
         L"échec du téléchargement — réessayez VÉRIFIER LES MISES À JOUR ou la page GitHub"},
